...
class ClickHouseSettings(BaseSettings):
    ...
    authors_commits_table: str = Field(
        validation_alias="CLICKHOUSE_REPOSITORIES_AUTHORS_COMMITS_TABLE",
    )
    positions_table: str = Field(validation_alias="CLICKHOUSE_REPOSITORIES_POSITIONS_TABLE")
